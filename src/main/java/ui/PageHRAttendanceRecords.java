...
public class PageHRAttendanceRecords extends ui.base.AbstractAdminAttendancePage {

    public PageHRAttendanceRecords() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PageHRAttendanceRecords.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
