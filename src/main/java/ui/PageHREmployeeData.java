...
public class PageHREmployeeData extends ui.base.AbstractProfilePage {

    public PageHREmployeeData() {
        initComponents();
    ...
    private void initComponents() {
        ...
        employeeRecordsButton = new util.LightButton();
        ...
        employeeRecordsButton.setForeground(new java.awt.Color(0, 102, 102));
        employeeRecordsButton.setText("View Employee Records");
        employeeRecordsButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                employeeRecordsButtonActionPerformed(evt);
            }
        });
        getContentPane().add(employeeRecordsButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 80, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PageHREmployeeData.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private util.LightButton employeeRecordsButton;
