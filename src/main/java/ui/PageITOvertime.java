...
public class PageITOvertime extends ui.base.AbstractOvertimePage {

    public PageITOvertime() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PageITOvertime.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
