...
public class PageFinanceAttendanceRecords extends ui.base.AbstractAdminAttendancePage {

    public PageFinanceAttendanceRecords() {
        initComponents();
        ...
        viewOwnRecordButton.addActionListener(e -> {
            new PageFinanceAttendance().setVisible(true);
            this.dispose();
        });
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PageFinanceAttendanceRecords.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PageFinanceAttendanceRecords().setVisible(true);
            }
        });
    }
