...
public class PageITHome extends ui.base.AbstractHomePage {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PageITHome.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
