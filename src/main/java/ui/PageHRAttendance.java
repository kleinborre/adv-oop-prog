...
public class PageHRAttendance extends ui.base.AbstractAttendancePage {

    public PageHRAttendance() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PageHRAttendance.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
