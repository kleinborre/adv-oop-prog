...
public class PageEmployeeAttendance extends ui.base.AbstractAttendancePage {

    public PageEmployeeAttendance() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PageEmployeeAttendance.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
