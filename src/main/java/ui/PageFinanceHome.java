...
public class PageFinanceHome extends ui.base.AbstractHomePage {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PageFinanceHome.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
